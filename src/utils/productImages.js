...
// Live AI results never include image URLs (models can't be trusted not to
// hallucinate a broken link for a specific SKU), so every item is matched to
// a representative category photo instead — better than no image, honest
// about not being the exact listing photo.
